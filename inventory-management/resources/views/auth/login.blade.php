    ...
    <div class="guest-layout">
        <div class="login-grid">
            <div class="login-hero">
                <img src="{{ asset('images/mtnima-logo.png') }}"
                     alt="MTNIMA"
                     style="width:7.5rem;height:auto;background:#fff;border-radius:0.75rem;padding:0.5rem;margin-bottom:1.25rem;box-shadow:0 8px 24px rgb(0 0 0 / 0.2);">
            ...
            <div class="login-form-panel">
                <div style="text-align:center;margin-bottom:1.5rem;">
                    <img src="{{ asset('images/mtnima-logo.png') }}" alt="MTNIMA" style="width:4rem;height:auto;margin:0 auto 0.75rem;display:block;">
