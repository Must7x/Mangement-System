@php
    $items = [
        ...
        ['route' => 'departments.index', 'pattern' => 'departments*', 'icon' => 'fa-building', 'label' => __('nav.departments')],
        ['route' => 'employees.index', 'pattern' => 'employees*', 'icon' => 'fa-user-tie', 'label' => __('nav.employees')],
    ];
